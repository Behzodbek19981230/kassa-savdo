...
export const orderService = {
    ...
    getOrdersMySelf: async (params?: {
        ...
        if (params?.all_product_summa_min != null)
            queryParams.append('all_product_summa_min', params.all_product_summa_min.toString());
        if (params?.total_debt_today_client_min != null)
            queryParams.append('total_debt_today_client_min', params.total_debt_today_client_min.toString());
        if (params?.total_debt_client_min != null)
            queryParams.append('total_debt_client_min', params.total_debt_client_min.toString());
...
export const debtRepaymentService = {
    ...
    // Qarz to'lovlarini sanaga bo'lib guruhlash
    getDebtRepaymentsGroupedByDate: async (params?: {
        date_from?: string;
        date_to?: string;
        client?: number;
        filial?: number;
...
export const vozvratOrderService = {
    ...
    editVozvratOrder: async (id: number, data: Partial<VozvratOrderRequest>): Promise<any> => {
        const response = await api.put(`/v1/vozvrat-order/${id}/edit`, data);
        return response.data;
    },
    returnVozvratOrder: async (id: number, data: Partial<VozvratOrderRequest>): Promise<any> => {
        const response = await api.put(`/v1/vozvrat-order/${id}/return`, data);
        return response.data;
    },
    ...
    // Vozvrat orderlarni sanaga bo'lib guruhlash
    getVozvratOrdersGroupedByDate: async (params?: {
        date_from?: string;
        date_to?: string;
        client?: number;
        employee?: number;
