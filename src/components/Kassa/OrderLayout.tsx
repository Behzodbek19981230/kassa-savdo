	...
	return (
		<div className='flex-1 flex flex-col md:flex-row gap-4 md:gap-0 min-h-0 h-full'>
			...
			{!readOnly && leftSidebar && (
				<div className='w-full md:w-1/2 md:min-w-[220px] md:max-w-lg md:border-r border-blue-200/50 bg-white md:bg-transparent flex flex-col min-h-0 overflow-hidden'>
					{leftSidebar}
				</div>
			)}
