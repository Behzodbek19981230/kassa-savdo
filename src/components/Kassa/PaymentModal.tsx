...
export function PaymentModal({
    ...
    const paymentMethods = [
        ...
        { id: 'terminal', name: 'Terminal', unit: 'UZS' as const, icon: CreditCard, gradient: 'from-blue-400 to-cyan-500', iconBg: 'bg-blue-100', iconColor: 'text-blue-700' },
    ];
                    ...
                    <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 mb-6'>
                        {paymentMethods.map((method) => {
                            ...
                            return (
                                <div
                                    key={method.id}
                                    className={`border-2 rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-all duration-200 ${isSelected ? 'border-indigo-400 ring-1 ring-indigo-200' : 'border-indigo-200'
                                        }`}
                                >
                                    <div
