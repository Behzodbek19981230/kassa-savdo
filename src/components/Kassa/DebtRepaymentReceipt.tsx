...
export function DebtRepaymentReceipt({
	...
	return (
		<div
			...
			style={{ background: '#fff', fontFamily: '"Times New Roman", serif', margin: 0, padding: '20px 0' }}
		>
			<style>{`
				@media print {
					body {
				...
				>
					...
					<div className='info-right' style={{ flex: 1 }}>
						<div
							...
							style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '6px' }}
						>
							<span className='label' style={{ fontWeight: 'bold', color: 'green' }}>
								Dollar kursi:
							</span>
							<span className='value' style={{ textAlign: 'right', color: 'green', fontWeight: 'bold' }}>
								{formatMoney(exchangeRate)} so'm
							</span>
						</div>
				...
				<div className='debt-section' style={{ marginTop: '30px' }}>
					...
					>
						...
						<div style={{ flex: 1 }}>
							<div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '12px' }}>
								...
								<span style={{ color: 'orange', fontWeight: 'bold' }}>{formatMoney(oldDebt)} $</span>
							</div>
						</div>
						...
						<div style={{ flex: 1, textAlign: 'right' }}>
							<div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '12px' }}>
								...
								<span style={{ fontWeight: 'bold' }}>{formatMoney(paidAmountDollar)} $</span>
							</div>
						</div>
					</div>
					...
					<div style={{ marginTop: '15px', fontSize: '16px' }}>
						<div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '12px' }}>
							...
							<span style={{ fontWeight: 'bold' }}>{formatMoney(totalPaidAmountDollar)} $</span>
						</div>
					</div>
					...
					<div style={{ marginTop: '20px', fontSize: '20px', fontWeight: 'bold' }}>
						<div style={{ display: 'flex', justifyContent: 'space-between' }}>
							...
							<span style={{ color: 'red' }}>{formatMoney(remainingDebt)} $</span>
						</div>
					</div>
				</div>
			</div>
