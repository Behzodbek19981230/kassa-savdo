				...
				<div className='flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2'>
							...
							<ul className='flex items-center gap-2'>
								<li>
									<NavLink
										to={ROUTES.HOME}
										className={({ isActive }) =>
											`px-2 py-1 rounded-md text-xs font-semibold transition flex items-center gap-1.5 whitespace-nowrap shrink-0 ${
								...
								<li>
									<NavLink
										...
										className={({ isActive }) =>
											`px-2 py-1 rounded-md text-xs font-semibold transition flex items-center gap-1.5 whitespace-nowrap ${
												isActive ? 'bg-white/20 text-white' : 'text-white/90 hover:bg-white/10'
											}`
										}
					...
					<div className='flex items-center flex-wrap gap-1.5 sm:gap-2 w-full sm:w-auto justify-end'>
						...
						<div className='flex items-center gap-2'>
							...
							<div
								className={`hidden md:flex items-center gap-1.5 bg-green-600 px-2 py-1 rounded-lg shadow-md ${
						...
						<div className='relative' ref={ddRef}>
							...
							{dropdownOpen && (
								<div className='absolute right-0 mt-1.5 w-[320px] p-1 z-50 rounded-lg border border-white/20 bg-slate-900/85 backdrop-blur-sm text-white shadow-lg'>
									<p className='px-2 py-1 text-[11px] font-semibold text-white/80'>
										Bildirishnomalar
									</p>
