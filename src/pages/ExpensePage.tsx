                        ...
                        <table className='w-full border-collapse text-xs'>
                            <thead>
                                <tr className='border-b-2 border-blue-200 bg-blue-50/50'>
                                    ...
                                    <th className='text-right p-1 font-semibold text-gray-700 min-w-[100px] text-xs'>Dollar ($)</th>
                                    <th className='text-right p-1 font-semibold text-gray-700 min-w-[100px] text-xs'>So'm</th>
                                    <th className='text-right p-1 font-semibold text-gray-700 min-w-[100px] text-xs'>Kilik</th>
                                    <th className='text-right p-1 font-semibold text-gray-700 min-w-[100px] text-xs'>Terminal</th>
                                    <th className='text-right p-1 font-semibold text-gray-700 min-w-[100px] text-xs'>Transfer</th>
