...
export function DatePicker({ date, onDateChange, placeholder = 'Sana tanlang', className, disabled }: DatePickerProps) {
	return (
		<Popover.Root>
			<Popover.Trigger asChild>
				<button
					...
					className={cn(
						'flex h-8 w-full items-center justify-between rounded-xl border border-indigo-200 bg-white px-4 py-2 text-sm',
						'ring-offset-white',
			...
			<Popover.Portal>
				<Popover.Content
					className={cn(
						'z-50 w-auto rounded-xl border border-indigo-200 bg-white p-3 shadow-lg',
