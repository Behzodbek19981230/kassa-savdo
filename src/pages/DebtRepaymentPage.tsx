...
export function DebtRepaymentPage() {
    ...
    const { data: groupedData, isLoading, error } = useQuery({
        queryKey: ['debt-repayments-grouped', { filial: user?.order_filial, dateFrom, dateTo }],
        queryFn: () =>
                    ...
                    <div className='flex items-center gap-3'>
                        <div className='flex items-center gap-2'>
                            ...
                            <input
                                ...
                                className='px-3 py-1.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-200 focus:border-blue-500 outline-none'
                            />
                        </div>
                        <div className='flex items-center gap-2'>
                                                    ...
                                                    {items.map((item: any) => {
                                                        ...
                                                        return (
                                                            ...
                                                            >
                                                                ...
                                                                <td className='p-2'>
                                                                    <span
                                                                        className={`px-2 py-1 rounded-full text-xs font-semibold ${item.debt_status
