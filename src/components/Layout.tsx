...
import { ArrowLeft, BarChart2, Clock, DollarSign, Plus, User, Building2, Loader2, LogOut } from 'lucide-react';
...
export function Layout({
	...
	return (
		<div className='flex flex-col min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-cyan-50 overflow-auto'>
			{/* Top Navigation Bar */}
							...
							<ul className='flex items-center gap-2'>
								...
								<li>
									<NavLink
										to='/statistika'
										className={({ isActive }) =>
											`px-3 py-2 rounded-md text-sm font-semibold transition flex items-center gap-2 whitespace-nowrap ${
												isActive ? 'bg-white/20 text-white' : 'text-white/90 hover:bg-white/10'
											}`
										}
										title='Statistika'
